...
public class ThreadPoolTransform implements TraceTransformer {
    ...
    private static void transformMethod(CtClass clazz, CtMethod method) throws NotFoundException, CannotCompileException {
            ...
            if (method.getDeclaringClass() == clazz) {
                ...
                if (Modifier.isPublic(modifiers) && !Modifier.isStatic(modifiers)) {
                    ...
                    for (int i = 0; i < parameterTypes.length; ++i) {
                        ...
                        } else if ("java.lang.concurrent.Callable".equals(parameterType.getName())) {
